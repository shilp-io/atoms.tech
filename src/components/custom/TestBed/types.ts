...
// Basic types
export type TestType = 'unit' | 'integration' | 'system' | 'acceptance' | 'performance' | 'security' | 'usability' | 'other';
export type TestPriority = 'critical' | 'high' | 'medium' | 'low';
export type TestStatus = 'draft' | 'ready' | 'in_progress' | 'blocked' | 'completed' | 'obsolete';
export type TestMethod = 'manual' | 'automated' | 'hybrid';
export type ExecutionStatus = 'not_executed' | 'in_progress' | 'passed' | 'failed' | 'blocked' | 'skipped';
