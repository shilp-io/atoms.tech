...
export function Navbar() {
    ...
    const navLinks = [
        ...
        { href: '/#how-it-works', label: 'How It Works', shortLabel: 'How It Works' },
        { href: '/#industries', label: 'Industries' },
        { href: '/#contact', label: 'Contact' },
    ];

    const NavLink = ({ href, label, shortLabel }: { href: string; label: string; shortLabel?: string }) => (
        <Link
            href={href}
        ...
        >
            <span className="hidden md:inline lg:hidden">{shortLabel || label}</span>
