        ...
        <div className="container mx-auto px-4">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <CardContent className="p-6">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-red-700 dark:text-red-400 mb-2">The Pain</h3>
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{painPoint}</p>
                    </div>
                    </div>
                </CardContent>
                </Card>
                ...
                <CardContent className="p-6">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-[#9B51E0] dark:text-[#9B51E0] mb-2">The Fix</h3>
