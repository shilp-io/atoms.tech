...
export const AddColumnDialog: React.FC<AddColumnDialogProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!/^[a-zA-Z0-9 ]+$/.test(columnName)) {
      setError('Column name can only contain letters, numbers, and spaces');
      return;
    }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new column for your table. This will add a new property to all requirements.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              >
                <SelectTrigger className="col-span-3" id="dataType">
