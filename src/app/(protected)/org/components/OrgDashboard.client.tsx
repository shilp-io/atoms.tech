...
import { Building, FileBox, FolderArchive, ListTodo, Users } from 'lucide-react';
        ...
        <div className="container mx-auto p-6 space-y-6">
            ...
            <div className="flex items-start justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">{organization?.description || 'Manage your organization resources'}</p>
                </div>
            ...
            <Tabs defaultValue="projects" value={activeTab} onValueChange={setActiveTab} className="w-full">
                                ...
                                {orgLoading ? (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">{organization?.member_count || 0}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-muted-foreground">Plan:</span>
                                            <span className="font-medium">{organization?.billing_plan}</span>
                                        </div>
                                    </div>
                                )}
                            </CardContent>
                                    ...
                                    <div className="space-y-4">
                                        <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                                            <div 
                                                ...
                                                style={{ width: `${Math.min(((organization?.storage_used || 0) / 1000) * 100, 100)}%` }}
                                            ></div>
                                        </div>
                                        <div className="flex justify-between text-sm">
                                            <span>{organization?.storage_used || 0} MB used</span>
                ...
                <TabsContent value="collections" className="space-y-6">
                    <div className="flex justify-between items-center">
                        <h2 className="text-xl font-semibold">File Collections</h2>
                        <button className="bg-primary text-primary-foreground px-4 py-2 rounded-md text-sm font-medium">
                            Create Collection
                        </button>
                    </div>
